...
1. Upload a trigger asset (e.g., a text file or placeholder) to the folder
2. Select the trigger asset
3. Manually trigger the "Firefly Available Voices" processing profile (Reprocess Assets)
...
6. Check the task details to view the available voice IDs
