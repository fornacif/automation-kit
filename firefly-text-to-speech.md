...
- **File:** [actions/firefly-services/firefly-text-to-speech.js](https://github.com/fornacif/automation-kit/blob/main/actions/firefly-services/firefly-text-to-speech.js)
