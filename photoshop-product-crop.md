...
- **File:** [actions/firefly-services/product-crop-automation.js](https://github.com/fornacif/automation-kit/blob/main/actions/firefly-services/product-crop-automation.js)
- **Action Name:** `firefly-services` (unified action in app.config.yaml)
- **Action Identifier:** `product-crop-automation` (passed via `actionName` parameter)
